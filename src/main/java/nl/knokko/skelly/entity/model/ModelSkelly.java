package nl.knokko.skelly.entity.model;
...
public class ModelSkelly extends ModelBiped
{
    public ModelSkelly()
    {
        this(0.0F, false);
    ...
    public ModelSkelly(float modelSize, boolean wither)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        if (itemstack != null && itemstack.getItem() == Items.BOW && ((EntitySkelly)entitylivingbaseIn).isSwingingArms())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        EntitySkelly entityskeleton = (EntitySkelly)entityIn;
